 ...
 */
import type { Block, PublicClient, WatchBlockNumberParameters, WatchBlocksParameters } from 'viem';
 ...
 */
export function watchBlockNumber(client: PublicClient, params: WatchBlockNumberParams): () => void {
	const watchParams: WatchBlockNumberParameters = {
 ...
 */
export function watchBlocks(client: PublicClient, params: WatchBlocksParams): () => void {
	// Only pass includeTransactions if explicitly set to true
	const watchParams: WatchBlocksParameters = {
	...
	if (params.includeTransactions === true) {
		(watchParams as { includeTransactions?: boolean }).includeTransactions = true;
	}
