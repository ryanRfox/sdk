 ...
 */
import type { Abi, Address, ContractFunctionArgs, ContractFunctionName, ContractFunctionReturnType, Hash, LocalAccount } from 'viem';
 ...
 */
export type WriteResult<TWait extends boolean | undefined> = TWait extends false ? Hash : RadiusReceipt;
/**
...
export type TypedContractRead<TAbi extends Abi> = {
    [TFunctionName in ContractFunctionName<TAbi, 'view' | 'pure'>]: (...args: ContractFunctionArgs<TAbi, 'view' | 'pure', TFunctionName> extends readonly [] ? [] : [args: ContractFunctionArgs<TAbi, 'view' | 'pure', TFunctionName>]) => Promise<ContractFunctionReturnType<TAbi, 'view' | 'pure', TFunctionName>>;
};
/**
...
export type TypedContractWrite<TAbi extends Abi> = {
    [TFunctionName in ContractFunctionName<TAbi, 'nonpayable' | 'payable'>]: <TWait extends boolean | undefined = true>(params: ContractFunctionArgs<TAbi, 'nonpayable' | 'payable', TFunctionName> extends readonly [] ? {
        signer: LocalAccount;
 ...
 * ```
 */
export declare function getContract<TAbi extends Abi>(client: RadiusClient, params: GetContractParameters<TAbi>): TypedContract<TAbi>;
