...
export declare function useERC20Balance({
  token,
  address,
}: UseERC20BalanceParams): import('wagmi').UseReadContractReturnType<
  readonly [
    {
      readonly name: 'name';
...
export declare function useERC20Allowance({
  token,
  owner,
  spender,
}: UseERC20AllowanceParams): import('wagmi').UseReadContractReturnType<
  readonly [
    {
      readonly name: 'name';
      readonly type: 'function';
  ...
  'allowance',
  readonly [owner: `0x${string}`, spender: `0x${string}`],
  bigint
>;
