...
export function RadiusProvider({ chain = radiusTestnet, children, queryClient, }) {
    ...
    return (_jsx(WagmiProvider, { config: config, children: _jsx(QueryClientProvider, { client: client, children: _jsx(RadiusContextProvider, { chain: chain, children: children }) }) }));
}
