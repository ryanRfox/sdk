...
const STALE_PATTERNS = [
	...
	{
		pattern: /createPrivateKeySigner/g,
		message: 'Reference to removed createPrivateKeySigner - use privateKeyToAccount from viem',
	},
	{ pattern: /@aspect-build\/radius-sdk/g, message: 'Reference to old package name' },
	{
		pattern: /createRadiusClient/g,
		message:
			'Reference to removed createRadiusClient - use createPublicClient/createWalletClient from viem',
	},
	{
		pattern: /client\.sendAndWait/g,
		message:
			'Reference to removed sendAndWait - use walletClient.sendTransaction + publicClient.waitForTransactionReceipt',
	},
	{
		pattern: /client\.publicClient/g,
		message: 'Reference to removed client.publicClient - use createPublicClient directly',
	},
	{
		pattern: /getContract\s*\(\s*client\s*,/g,
		message:
			"Reference to old SDK getContract signature - use viem's getContract({ address, abi, client })",
	},
];
...
const REQUIRED_FILES = ['api/README.md', 'api/index.md', 'guides/quick-start.mdx'];
